...
namespace PortfolioEngine.Infrastructure.Migrations
{
    ...
    [Migration("20260819233436_messages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColleagueProject", b =>
                {
                    b.Property<Guid>("ColleaguesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ColleaguesId", "ProjectId");

                    b.HasIndex("ProjectId");

                    b.ToTable("ProjectColleagues", (string)null);
                });
            ...
            modelBuilder.Entity("PortfolioEngine.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PortfolioEngine.Domain.Entities.Colleague", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PortfolioEngine.Domain.Entities.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PortfolioEngine.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PortfolioEngine.Domain.Entities.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ColleagueProject", b =>
                {
                    b.HasOne("PortfolioEngine.Domain.Entities.Colleague", null)
                        .WithMany()
                        .HasForeignKey("ColleaguesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PortfolioEngine.Domain.Entities.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PortfolioEngine.Domain.Entities.ApplicationUser", null)
                        .WithMany()
