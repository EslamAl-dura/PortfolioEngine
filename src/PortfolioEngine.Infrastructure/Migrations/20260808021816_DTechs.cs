...
{
    /// <inheritdoc />
    public partial class DTechs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "TechCatagoryId",
                table: "Technologies",
                newName: "TechCategoryId");

            migrationBuilder.RenameIndex(
                name: "IX_Technologies_TechCatagoryId",
                table: "Technologies",
                newName: "IX_Technologies_TechCategoryId");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechCategories", x => x.Id);
                });

            migrationBuilder.AddForeignKey(
                name: "FK_Technologies_TechCategories_TechCategoryId",
                table: "Technologies",
                column: "TechCategoryId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_Technologies_TechCategoryId",
                table: "Technologies",
